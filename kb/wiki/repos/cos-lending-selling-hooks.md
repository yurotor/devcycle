...
[CRB.CosLending.Hooks.Hub.Service](../repos/crb-coslending-hooks-hub-service.md), [NServiceBus](../repos/nservicebus.md), [OAuth Identity Provider](../repos/oauth-identity-provider.md)
